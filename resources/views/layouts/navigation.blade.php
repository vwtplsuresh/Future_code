...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                @role('admin')
                <div class="flex items-center shrink-0 mw-5 sm-mw-100">
                    <a href="{{ route('admin.index') }}">
                        <x-application-logo-icon class="block w-auto text-gray-800 fill-current h-9 dark:text-gray-200" />
                ...
                @role('operator')
                <div class="flex items-center shrink-0 mw-5">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.zones.index')" :active="request()->routeIs('admin.zones.index')">
                        {{ __('Zones') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.units.index')" :active="request()->routeIs('admin.units.index')">
                        {{ __('Units') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.alldata')" :active="request()->routeIs('admin.alldata')">
                        {{ __('All Units Data') }}
                    </x-nav-link> --}}
                    @endrole
                    ...
                    <x-nav-link :href="route('operator.reports.index')" :active="request()->routeIs('operator.reports.index')">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
                        </svg>

                        {{ __('Reports') }}
                    </x-nav-link>
                    <x-nav-link :href="route('operator.settings.index')" :active="request()->routeIs('operator.settings.index')">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m16.5 0H21m-1.5 0H12m-8.457 3.077l1.41-.513m14.095-5.13l1.41-.513M5.106 17.785l1.15-.964m11.49-9.642l1.149-.964M7.501 19.795l.75-1.3m7.5-12.99l.75-1.3m-6.063 16.658l.26-1.477m2.605-14.772l.26-1.477m0 17.726l-.26-1.477M10.698 4.614l-.26-1.477M16.5 19.794l-.75-1.299M7.5 4.205L12 12m6.894 5.785l-1.149-.964M6.256 7.178l-1.15-.964m15.352 8.864l-1.41-.513M4.954 9.435l-1.41-.514M12.002 12l-3.75 6.495" />
                        </svg>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role('operator')
            <x-responsive-nav-link :href="route('operator.index')" :active="request()->routeIs('operator.index')">
                {{ __('Dashboard') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('operator.index')" :active="request()->routeIs('operator.index')">
                {{ __('Trends') }}
            ...
            <x-responsive-nav-link :href="route('operator.settings.index')" :active="request()->routeIs('operator.settings.index')">
                {{ __('Settings') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link>
                {{ __('Contact Requests') }}
