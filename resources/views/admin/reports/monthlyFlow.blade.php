        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="mb-4 overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form class="form" action="{{ route('admin.reports.get.monthlyFlow') }}" method="post">
                        @csrf
                        <div class="row">
                                ...
                                <tbody>
                                    @foreach ($monthlyFlow as $flow)
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a title="Edit Monthly Flow" href="{{ '/admin/reports/editMonthlyFlow/'.$currntMonth.'/'.$flow->id.'/'.$flow->location->id.'/'.$flow->zone->id }}" class="m-2 btn btn-primary d-inline-flex">
