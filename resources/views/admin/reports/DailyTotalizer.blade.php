        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-4">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form class="form" action="{{ route('admin.reports.get.dailyTotalizerReport') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-3 col-lg-3 col-sm-12 form-group mb-2">
                                <x-input-label for="location" :value="__('Location')" />
                                <select class="form-control mt-1" id="locations" name="location">
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-12 form-group mb-2">
                                ...
                                <select class="form-control mt-1" id="zones" name="zone">
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-12 form-group mb-2">
                                ...
                                <select class="form-control mt-1" id="units" name="unit">
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-12 form-group mb-2">
                                ...
                                <x-text-input id="date" class="block mt-1 w-full" type="date" name="date" min="{{ date('Y-m-d', strtotime('-7 days')) }}" max="{{ date('Y-m-d') }}" :value="old('date')" />
                        ...
                        <table class="table table-sm " id="report-table">
                            <thead class=" text-primary" style="font-size: 12px;">
                                <tr>
                                    ...
                                    <td scope="col" colspan="2">{{ $report->title }}</td>
                                </tr>
                                <tr>
                                    <th scope="col">Loction</th>
                                    <td scope="col" colspan="2">{{ $report->location->title }}</td>
                                </tr>
                                <tr>
                                    <th scope="col">Zone</th>
                                    <td scope="col" colspan="2">{{ $report->zone->title }}</td>
                                </tr>
                                <tr>
                                    <th scope="col">Address</th>
                                    <td scope="col" colspan="2">{{ $report->address }}</td>
                                </tr>
                                <tr>
                                    <td colspan="3"></td>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $flow->totalizer }}</td>
                                    <td>{{ $flow->is_panel_lock ? "Locked" : "Un-Locked" }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
