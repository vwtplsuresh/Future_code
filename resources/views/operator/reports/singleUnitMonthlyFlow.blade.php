        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-4">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form class="form" action="{{ route('operator.reports.get.singleUnitMonthlyFlow') }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-3 col-lg-3 col-sm-12 form-group mb-2">
                                ...
                                <x-text-input id="month" class="block mt-1 w-full" type="month" name="month" min="{{ (date('Y')-1) }}-{{ date('m') }}" max="{{ date('Y-m') }}" :value="old('month')" />
