        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="post" action="{{ route('operator.units.update', $unit->id) }}">
                        @csrf
                        @method("PUT")
                        <div class="row">
                            <div class="py-2 col-sm-12 col-xs-12 col-md-4 col-lg-4 col-xl-4">
                                <x-input-label for="user_id" :value="__('User')" />
                                <select class="mt-1 form-control" id="user_id" name="user_id">
                            ...
                            <div class="py-2 col-sm-12 col-xs-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <select class="mt-1 form-control" id="location_id" name="location_id">
                            ...
                            <div class="py-2 col-sm-12 col-xs-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <select class="mt-1 form-control" id="zone_id" name="zone_id">
                        ...
                        <div class="row">
                            ...
                            <div class="py-2 col-sm-12 col-xs-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <x-text-input id="panel_no" class="block w-full mt-1" type="text" name="panel_no" :value="old('panel_no', $unit->panel_no)" placeholder="Unit Panel No." />
                                <x-input-error :messages="$errors->get('panel_no')" class="mt-2" />
                            </div>
                            <div class="py-2 col-sm-12 col-xs-12 col-md-4 col-lg-4 col-xl-4">
                                <x-input-label for="title" :value="__('Title')" />
                                <x-text-input id="title" class="block w-full mt-1" type="text" name="title" :value="old('title', $unit->title)" placeholder="Unit Name" />
                                <x-input-error :messages="$errors->get('title')" class="mt-2" />
                            </div>
                            <div class="py-2 col-sm-12 col-xs-12 col-md-4 col-lg-4 col-xl-4">
                                <x-input-label for="address" :value="__('Address')" />
                                <x-text-input id="address" class="block w-full mt-1" type="text" name="address" :value="old('address', $unit->address)" placeholder="Unit Address" />
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="py-2 col-sm-12 col-xs-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <x-text-input id="operator_name" class="block w-full mt-1" type="text" name="operator_name" placeholder="Full Name" :value="old('operator_name', $unit->operator_name)" />
                                <x-input-error :messages="$errors->get('operator_name')" class="mt-2" />
                            </div>
                            <div class="py-2 col-sm-12 col-xs-12 col-md-6 col-lg-6 col-xl-6">
                                <x-input-label for="operator_mobile" :value="__('Operator Mobile')" />
                                <x-text-input id="operator_mobile" class="block w-full mt-1" type="text" placeholder="example:12345789" name="operator_mobile" :value="old('operator_mobile', $unit->operator_mobile)" />
                        ...
                        <div class="mt-3 row">
                            ...
                            <div class="py-2 col-sm-6 col-xs-6 col-md-2 col-lg-2 col-xl-2">
                                ...
                                <x-text-input id="total_limit" class="block w-full mt-1" type="text" placeholder="0.00" name="total_limit" :value="old('total_limit', $unit->total_limit)" />
                                <x-input-error :messages="$errors->get('total_limit')" class="mt-2" />
                            </div>
                            <div class="py-2 col-sm-6 col-xs-6 col-md-2 col-lg-2 col-xl-2">
                                <x-input-label for="today_limit" :value="__('Today Limit (%)')" />
                                <x-text-input id="today_limit" class="block w-full mt-1" type="text" placeholder="100" help="Today limit will be in %" name="today_limit" :value="old('today_limit', $unit->today_limit)" />
                                <x-input-error :messages="$errors->get('today_limit')" class="mt-2" />
                            </div>
                            <div class="py-2 col-sm-6 col-xs-6 col-md-2 col-lg-2 col-xl-2">
                                <x-input-label for="plc_reset" :value="__('PLC Reset')" />
                                <select class="mt-1 form-control" id="plc_reset" name="plc_reset">
                            ...
                            <div class="py-2 col-sm-6 col-xs-6 col-md-2 col-lg-2 col-xl-2">
                                ...
                                <select class="mt-1 form-control" id="panel_lock" name="panel_lock">
                            ...
                            <div class="py-2 col-sm-6 col-xs-6 col-md-2 col-lg-2 col-xl-2">
                                ...
                                <select class="mt-1 form-control" id="reset_totalizer" name="reset_totalizer">
                            ...
                            <div class="py-2 col-sm-6 col-xs-6 col-md-2 col-lg-2 col-xl-2">
                                ...
                                <select class="mt-1 form-control" id="reset_memory" name="reset_memory">
                        ...
                        <div class="mt-3 row">
                            ...
                            <div class="py-2 col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
                                <x-input-label for="panel_unlock_timings" :value="__('Panel Un-lock Timings')" />
                                <x-text-input id="panel_unlock_timings" class="block w-full mt-1" type="text" name="panel_unlock_timings" placeholder="06-09,14-16,22-00" :value="old('panel_unlock_timings', $unit->panel_unlock_timings)" />
                                <x-input-error :messages="$errors->get('panel_unlock_timings')" class="mt-2" />
                            </div>

                            <div class="py-2 col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
                                <x-input-label for="panel_unlock_dates" :value="__('Panel Un-lock Dates')" />
                                <x-text-input id="panel_unlock_dates" class="block w-full mt-1" type="text" name="panel_unlock_dates" placeholder="02,08,12,20,25" :value="old('panel_unlock_dates', $unit->panel_unlock_dates)" />
                                <x-input-error :messages="$errors->get('panel_unlock_dates')" class="mt-2" />
                            </div>

                            <div class="py-2 col-sm-6 col-xs-6 col-md-2 col-lg-2 col-xl-2">
                                <x-input-label for="mode" :value="__('Mode')" />
                                <select class="mt-1 form-control" id="mode" name="mode">
                            ...
                            <div class="py-2 col-sm-6 col-xs-6 col-md-2 col-lg-2 col-xl-2">
                                ...
                                <x-text-input id="pipe_size" class="block w-full mt-1" type="text" placeholder="0.00" name="pipe_size" :value="old('pipe_size', $unit->pipe_size)" />
                                <x-input-error :messages="$errors->get('pipe_size')" class="mt-2" />
                            </div>
                            <div class="py-2 col-sm-6 col-xs-6 col-md-2 col-lg-2 col-xl-2">
                                <x-input-label for="tds_bit" :value="__('TDS Bit')" />
                                <select class="mt-1 form-control" id="tds_bit" name="tds_bit">
                        ...
                        <div class="mt-3 row">
                            ...
                            <div class="py-2 col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
                                ...
                                <x-text-input id="min_tds" class="block w-full mt-1" type="number" name="min_tds" placeholder="0" :value="old('min_tds', number_format((float)$unit->min_tds, 2, '.', ''))" />
                            ...
                            <div class="py-2 col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
                                ...
                                <x-text-input id="max_tds" class="block w-full mt-1" type="number" name="max_tds" placeholder="0" :value="old('max_tds', number_format((float)$unit->max_tds, 2, '.', ''))" />
                            ...
                            <div class="py-2 col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
                                ...
                                <x-text-input id="cto" class="block w-full mt-1" type="text" name="cto" placeholder="CTO" :value="old('cto', $unit->cto)" />
                                <x-input-error :messages="$errors->get('cto')" class="mt-2" />
                            </div>

                            <div class="py-2 col-sm-12 col-xs-12 col-md-3 col-lg-3 col-xl-3">
                                <x-input-label for="cto_remark" :value="__('CTO Remark')" />
                                <x-textarea id="cto_remark" class="block w-full mt-1" type="text" name="cto_remark" placeholder="CTO Remark" :value="old('cto_remark', $unit->cto_remark)" ></x-textarea>
