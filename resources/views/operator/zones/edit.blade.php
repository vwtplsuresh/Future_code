        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('operator.zones.update', $zone->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="py-2 col-sm-12 col-xs-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <x-text-input id="title" class="block w-full mt-1" type="text" name="title" :value="old('title', $zone->title)" />
