<x-operator-layout>
    ...
    <div class="px-4 py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="mb-2 col-xl-3 col-lg-6">
                    <div class="card l-bg-info">
                        <div class="p-4 card-statistic-3">
                            ...
                            <div class="mb-4">
                                <a href="{{ route('operator.locations.show', $location->id) }}">
            ...
            <div class="mb-4 row">
                <div class="mb-2 col-xl-5 col-lg-5 col-md-5 col-sm-12">
                ...
                <div class="mb-2 col-xl-7 col-lg-7 col-md-7 col-sm-12">
                    <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <div class="">
