...
class ZoneController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('operator.zones.index', ['zones' => $zones]);
    }
    ...
    public function create()
    {
        ...
        return view('operator.zones.create', ['locations' => $locations]);
    }
    ...
    public function store(ZoneRequest $request)
    {
        ...
        $zone->save();
        return redirect()->route('operator.zones.index')->withStatus('Zone added successfully !');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('operator.zones.show', ['zone' => $Zone, "units" => $sortedData]);
    }
    ...
    public function edit(string $id)
    {
        $locations = Location::all();
        $Zone = Zone::with('location')->findOrFail($id);
        return view('operator.zones.edit', ['zone' => $Zone, 'locations' => $locations]);
    }
    ...
    public function update(ZoneRequest $request, string $id)
    {
        ...
        return redirect()->route('operator.zones.index')->withStatus('Zone updated successfully !');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('operator.zones.index')->withStatus('Zone deleted successfully !');
    }
}
