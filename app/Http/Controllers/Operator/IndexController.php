...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($locations as $location) {
            // $onlineUnits = Unit::with('online')->where('location_id', $location->id)->toSql();
            // $oflineUnits = Unit::with('offline')->where('location_id', $location->id)->toSql();
        ...
        return view('operator.index', ['locations' => $locations, 'chartData' => json_encode($chartData), 'allData' => $allData, 'totals' => $totals]);
